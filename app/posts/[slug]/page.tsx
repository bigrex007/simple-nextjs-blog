      ...
      <main className="mx-auto flex flex-col justify-center">
        <div className="mx-auto flex w-full flex-col items-start justify-center px-4 md:flex-row">
          <div className="mt-4 flex justify-start pb-4 md:justify-center md:pb-0 md:pr-20">
            <Link
              href="/"
              className="rounded-full border border-zinc-100 bg-white p-2 text-white dark:text-white shadow-md dark:border-zinc-800 dark:bg-zinc-950"
            >
            ...
            {post && (
              <>
                <div className="flex flex-col justify-between space-y-4 pb-8 md:flex-row md:space-y-0">
                  <div className="flex items-center space-x-2 text-white dark:text-white md:space-y-0">
            ...
            <div className="mx-auto mt-8 w-full">
              ...
              {suggestedPosts && (
                <div className="flex w-full flex-col">
                  <h3 className="pb-3 text-xl font-semibold text-white text-white">
                    Sugerencias
                  </h3>
